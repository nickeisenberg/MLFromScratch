...
b1 = torch.Tensor([5, 5, 5, 5])
b2 = torch.Tensor([6, 6, 5, 5])

iou(b1, b2, share_center=False)
_iou(b1, b2, is_pred=True)
intersection_over_union(b1, b2, box_format='midpoint')

iou(b1, b2, share_center=True)
_iou(b1, b2, is_pred=False)
iou_width_height(b1[2:], b2[2:])
